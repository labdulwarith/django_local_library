...
class Book(models.Model):
    ...
    isbn = models.CharField(
        ...
        max_length=13,
        unique=True,
        help_text='13 Character <a href="https://isbn-international.org/content/what-is-isbn''">ISBN number</a>'
    )
...
class Language(models.Model):
    name=models.CharField(
        max_length=100,
        unique=True,
        help_text="Enter a book's natural language e.g(English, Yapanese) etc."
    )
