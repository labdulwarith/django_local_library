# Generated by Django 5.0.7 on 2024-07-11 14:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text='13 Character <a href="https://isbn-international.org/content/what-is-isbn">ISBN number</a>', max_length=13, unique=True, verbose_name='ISBN')),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre for this field', to='catalog.genre'),
        ),
    ]
